    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      <div
        style={{
          ...
          paddingBottom: "calc(var(--safe-bottom, 0px) + var(--space-xl))",
        }}
      >
        {/* Number display */}
        <div style={{ textAlign: "center", padding: "var(--space-lg) 0", minHeight: 60 }}>
          <span
            style={{
              fontSize: number.length > 12 ? 24 : 34,
              fontWeight: 200,
        ...
        >
          ...
          >
            <svg
              ...
              height="28"
              viewBox="0 0 24 24"
              fill={number ? "#fff" : "var(--color-text-tertiary)"}
            >
...
const DialKey = memo(function DialKey({
  digit,
  letters,
  onPress,
}: { digit: string; letters: string; onPress: (d: string) => void }) {
  return (
    <motion.button
      type="button"
