  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding:
          "calc(var(--safe-top, 0px) + var(--space-3xl)) var(--space-lg) calc(var(--safe-bottom, 0px) + var(--space-2xl))",
        background:
          "linear-gradient(180deg, rgba(15,15,30,0.95) 0%, rgba(20,20,50,0.98) 50%, rgba(10,10,35,0.95) 100%)",
    ...
    >
      ...
      <div style={{ textAlign: "center" }}>
        <motion.div
          animate={
            isRinging
              ? {
                  boxShadow: [
                    "0 0 0 0 rgba(110,142,251,0.4)",
                    "0 0 0 28px rgba(110,142,251,0)",
                    "0 0 0 0 rgba(110,142,251,0.4)",
                  ],
                }
              : {}
          }
          transition={isRinging ? { duration: 2, repeat: Number.POSITIVE_INFINITY } : {}}
          style={{
            width: 100,
            height: 100,
            borderRadius: "50%",
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: "var(--space-sm)" }}>
          <LineBadge
            simId={activeCall.simId}
            extraNumberId={activeCall.extraNumberId}
            showCarrier
            size="md"
          />
        </div>
...
const CallButton = memo(function CallButton({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
      ...
      <span style={{ fontSize: "var(--font-size-caption)", color: "rgba(255, 255, 255, 0.6)" }}>
        {label}
      </span>
    </div>
  );
