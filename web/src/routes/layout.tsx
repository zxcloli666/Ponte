...
export function Layout() {
  ...
  const tabs = [
    { path: "/sms", label: "\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u044f", icon: <MsgIcon />, activeIcon: <MsgIconActive />, badge: smsUnread },
    { path: "/calls", label: "\u0412\u044b\u0437\u043e\u0432\u044b", icon: <CallIcon />, activeIcon: <CallIconActive /> },
    { path: "/notifications", label: "\u0423\u0432\u0435\u0434\u043e\u043c\u043b\u0435\u043d\u0438\u044f", icon: <BellIcon />, activeIcon: <BellIconActive />, badge: notifCount > 0 ? notifCount : undefined },
    { path: "/contacts", label: "\u041a\u043e\u043d\u0442\u0430\u043a\u0442\u044b", icon: <UserIcon />, activeIcon: <UserIconActive /> },
  ];

  return (
    <div style={{ height: "100%", display: "flex", flexDirection: "column", position: "relative" }}>
      <main style={{ flex: 1, overflow: "hidden", paddingBottom: hideTabBar ? 0 : "calc(var(--tab-bar-height) + 24px)" }}>
